...
namespace CommonTest.DB.DAO.Impl.DataSet2Test
{
    ...
    public class DataSet2DAOimplTests
    {
        ...
        {
            Mock<DataSet2> mds1 = new Mock<DataSet2>(wid, code, wv, DateTime.Now);

            Mock<IDataSet2DAO> mock = new Mock<IDataSet2DAO>();

            mock.Setup(p => p.Save(mds1.Object as DataSet2)).Returns(1);
        }
        ...
        {
            DataSet2 ds1 = new DataSet2(wid, code, wv, DateTime.Now);
        ...
        {
            DataSet2 ds1 = new DataSet2(wid, code, wv, DateTime.Now);
            DataSet2 ds12 = new DataSet2(wid + 1, code, wv + 1, DateTime.Now);
        ...
        public void FindAllSaveDeleteAll()
        {
            ...
            List<DataSet2> expectedList = new List<DataSet2>()
        {
            new DataSet2(wid, code, 1, new DateTime(2020, 1, 1)),
            new DataSet2(wid, code, 2, new DateTime(2020, 2, 1)),
            new DataSet2(wid, code, 3, new DateTime(2020, 3, 1))
        };

            DataSet2 ds1 = new DataSet2(wid, code, 1, new DateTime(2020, 1, 1));
            DataSet2 ds2 = new DataSet2(wid, code, 2, new DateTime(2020, 2, 1));
            DataSet2 ds3 = new DataSet2(wid, code, 3, new DateTime(2020, 3, 1));
            ...
            List<DataSet2> expectedList = new List<DataSet2>()
        {
            ...
            new DataSet2(wid, code, 2, new DateTime(2020, 2, 1)),
            new DataSet2(wid, code, 3, new DateTime(2020, 3, 1)),
            new DataSet2(wid, "code2", 4, new DateTime(2020, 4, 1))
        };
