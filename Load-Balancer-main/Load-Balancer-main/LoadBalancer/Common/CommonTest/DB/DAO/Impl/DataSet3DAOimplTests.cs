...
namespace CommonTest.DB.DAO.Impl.DataSet3Test
{
    [ExcludeFromCodeCoverage]
    [TestFixture]
    public class DataSet3DAOimplTests
    {
        [Test]
        ...
        {
            Mock<DataSet3> mds1 = new Mock<DataSet3>(wid, code, wv, DateTime.Now);

            Mock<IDataSet3DAO> mock = new Mock<IDataSet3DAO>();

            mock.Setup(p => p.Save(mds1.Object as DataSet3)).Returns(1);
        }
        ...
        {
            DataSet3 ds1 = new DataSet3(wid, code, wv, DateTime.Now);
        ...
        {
            DataSet3 ds1 = new DataSet3(wid, code, wv, DateTime.Now);
            DataSet3 ds12 = new DataSet3(wid + 1, code, wv + 1, DateTime.Now);
        ...
        public void FindAllSaveDeleteAll()
        {
            ...
            List<DataSet3> expectedList = new List<DataSet3>()
        {
            new DataSet3(wid, code, 1, new DateTime(2020, 1, 1)),
            new DataSet3(wid, code, 2, new DateTime(2020, 2, 1)),
            new DataSet3(wid, code, 3, new DateTime(2020, 3, 1))
        };

            DataSet3 ds1 = new DataSet3(wid, code, 1, new DateTime(2020, 1, 1));
            DataSet3 ds2 = new DataSet3(wid, code, 2, new DateTime(2020, 2, 1));
            DataSet3 ds3 = new DataSet3(wid, code, 3, new DateTime(2020, 3, 1));

            DataSet3DAOimpl d = new DataSet3DAOimpl();
            d.DeleteAll();
            ...
            List<DataSet3> expectedList = new List<DataSet3>()
        {
            ...
            new DataSet3(wid, code, 2, new DateTime(2020, 2, 1)),
            new DataSet3(wid, code, 3, new DateTime(2020, 3, 1)),
            new DataSet3(wid, "code2", 4, new DateTime(2020, 4, 1))
        };
